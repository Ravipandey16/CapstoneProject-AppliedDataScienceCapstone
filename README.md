...
This repository contains the final capstone project completed as part of a Coursera Data Science specialization. The project demonstrates an end-to-end data science workflow, covering data collection, data wrangling, exploratory data analysis (EDA), SQL-based analysis, interactive visualizations, dashboard development, and predictive modeling.
...
- Built interactive maps and dashboards for visual analytics
...
⭐ Feel free to explore the repository and review the notebooks and dashboard for detailed analysis.
